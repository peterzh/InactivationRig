...
%             save(obj.laserCfg.calibFile,'volt2laserPower');
            temp_fileName = strrep(obj.laserCfg.calibFile, '.mat', ['_' datestr(now,29) '.mat']);
            save(temp_fileName,'volt2laserPower');
            warning('saved calibration to temp file, need to rename to %s to be used',obj.laserCfg.calibFile);
        ...
        function plotCalibPower2Volt(obj)
